...
NetworkServer::NetworkServer(SnapshotPacketBuffer& packetBuffer, NetworkEventQueue& networkEventQueue): snapshotPacketBuffer(packetBuffer), eventQueue(networkEventQueue)
{
	WSADATA wsa;
